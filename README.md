...
- **DOG API** —— 36 章 + 附录 A–R，正文并入 5 个 PART、节号写作 `§X.Y`。嗅觉阵列全双工、摇尾的方向性编码、地磁对齐、全天行为预算、生理基线、就医标准场景、量化接口定义、表情接口定义、外设总线、HUMAN 互操作，以及 §5.3《领养与授权》。
...
├── spec/
│   ├── dog.html                  DOG API（36 章 + 附录 A–R，§X.Y）
